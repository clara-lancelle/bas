            ...
            <div className="container my-18 flex gap-8">
                ...
                <div className="w-3/4">
                    ...
                    <div className="flex flex-col">
                        {offers?.map(({ id, companyName, picto_image, name, start_date, end_date, city, job_profiles, calcul_limit_date, calcul_duration, ...items }) => (
                            <div key={name + id} className="p-6 border border-white-light mb-4">
                                <div className="flex justify-between">
                                    ...
                                    <div className="ms-6">
                                        ...
                                        <p className="mb-2"><span className="font-bold">{companyName}</span> • {city} • Du {start_date} au {end_date} ({calcul_duration} jours)</p>
                                        <div className="">
                                    ...
                                    <div className="flex flex-col">
                                        ...
                                        <span className="text-xs">Reste {calcul_limit_date} jours pour postuler</span>
                                    </div>
                                </div>
                            </div>
                        ))}
